...
--user(belong to multiple tenant)
...
--events(one user belong to multiple user)
...
create policy tenant_isoloation_policy on analytics.event using (tenant_id=current_setting('app.current_tenant'))
